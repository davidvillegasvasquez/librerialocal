...
#Atención: duré como 3 horas tirando flecha para la vista de reiniciar el contador: si nó coloco un texto, así sea un sólo caracter en la url (en este ejem puse x, pero debe ser /),  y dejo las comillas vacias, se tomará 
